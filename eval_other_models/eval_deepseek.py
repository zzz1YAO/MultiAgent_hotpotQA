...
def preprocess_hotpot_file(file_path):
    ...
    return processed
 # 从环境变量读取
MODEL_NAME = "deepseek-r1"  # 可替换为 "gpt-4"
client = OpenAI(api_key="sk-dQbAHSLUNhqbcbNxX7eZGn2pVh5ZWlXphW2Falip9RvxaES6", base_url="https://api.lkeap.cloud.tencent.com/v1")
...
# 最终保存（带时间戳）
output_path = f"results_deepseek_r1.json"
